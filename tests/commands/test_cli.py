...
from neo.commands.doctor import parse_java_major
...
class ParseArgsTests(unittest.TestCase):
    ...
    def test_build_args_include_version(self) -> None:
        args = cli.parse_args(["build", "--version", "11.3.0-release.0"])
...
class JavaVersionTests(unittest.TestCase):
    def test_parse_java_major_from_modern_output(self) -> None:
        self.assertEqual(parse_java_major("openjdk 21.0.2 2024-01-16\n"), 21)

    def test_parse_java_major_from_legacy_output(self) -> None:
        self.assertEqual(parse_java_major('java version "17.0.10"\n'), 17)
